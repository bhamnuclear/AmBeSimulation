...
ActionInitialization::ActionInitialization(int rank, int NumberOfThreads, DetectorConstruction* detectorConstruction, bool FissFragments, G4String RadioIsotope, bool InitialNeutrons):
